(() => {
  ...
  // elm:/Users/y047aka/Github/elm-app-templates/esbuild/src/Main.elm
  var require_Main = __commonJS({
    "elm:/Users/y047aka/Github/elm-app-templates/esbuild/src/Main.elm"(exports) {
      (function(scope) {
        "use strict";
        ...
        var $elm$browser$Debugger$Main$decodeDimension = function(field) {
          return A2($elm$json$Json$Decode$at, _List_fromArray(["currentTarget", "ownerDocument", "defaultView", field]), $elm$json$Json$Decode$float);
        };
        ...
        var $elm$browser$Debugger$Expando$lineStarter = F3(function(maybeKey, maybeIsClosed, description) {
          ...
          if (maybeKey.$ === "Nothing") {
            ...
            var key = maybeKey.a;
            return A2($elm$core$List$cons, arrow, A2($elm$core$List$cons, A2($elm$html$Html$span, _List_fromArray([$elm$browser$Debugger$Expando$purple]), _List_fromArray([
        ...
        var $elm$browser$Debugger$Expando$viewExtraTinyRecord = F3(function(length, starter, entries) {
          if (!entries.b) {
            return _Utils_Tuple2(length + 1, _List_fromArray([
              $elm$html$Html$text("}")
            ]));
          } else {
            var field = entries.a;
            ...
            if (nextLength > 18) {
              return _Utils_Tuple2(length + 2, _List_fromArray([
                $elm$html$Html$text("\u2026}")
              ]));
            } else {
              ...
              return _Utils_Tuple2(finalLength, A2($elm$core$List$cons, $elm$html$Html$text(starter), A2($elm$core$List$cons, A2($elm$html$Html$span, _List_fromArray([$elm$browser$Debugger$Expando$purple]), _List_fromArray([
        ...
        var $elm$browser$Debugger$Expando$viewTiny = function(value) {
          switch (value.$) {
            case "S":
              ...
              return _Utils_Tuple2($elm$core$String$length(str), _List_fromArray([
                A2($elm$html$Html$span, _List_fromArray([$elm$browser$Debugger$Expando$red]), _List_fromArray([
                  $elm$html$Html$text(str)
                ]))
              ]));
            case "Primitive":
              ...
              return _Utils_Tuple2($elm$core$String$length(stringRep), _List_fromArray([
                A2($elm$html$Html$span, _List_fromArray([$elm$browser$Debugger$Expando$blue]), _List_fromArray([
        ...
        var $elm$browser$Debugger$Expando$viewTinyRecordHelp = F3(function(length, starter, entries) {
          if (!entries.b) {
            ...
            if (newLength > 60) {
              return _Utils_Tuple2(length + 4, _List_fromArray([
                $elm$html$Html$text(", \u2026 }")
              ]));
            } else {
          ...
          fromListHelp:
            while (true) {
              ...
              if (_Utils_cmp($elm$core$Elm$JsArray$length(jsArray), $elm$core$Array$branchFactor) < 0) {
                return A2($elm$core$Array$builderToArray, true, { nodeList, nodeListSize, tail: jsArray });
              } else {
        ...
        var $elm$browser$Debugger$Main$viewHistorySlider = F2(function(history2, maybeIndex) {
        ...
        var $elm$browser$Debugger$Main$viewHistory = F3(function(maybeIndex, history2, layout) {
          var block = $elm$browser$Debugger$Main$toMouseBlocker(layout);
          ...
          return A2($elm$html$Html$div, _List_fromArray([
            ...
            A2($elm$html$Html$map, $elm$browser$Debugger$Main$Jump, A2($elm$browser$Debugger$History$view, maybeIndex, history2)),
        ...
        var $elm$browser$Debugger$Main$download = F2(function(metadata, history2) {
          ...
          return A2($elm$core$Task$perform, function(_v0) {
            ...
            _Utils_Tuple2("history", $elm$browser$Debugger$History$encode(history2))
          ])))));
        });
        ...
        var $elm$browser$Debugger$History$get = F3(function(update, index, history2) {
          get:
            while (true) {
        ...
        var $elm$browser$Debugger$History$decoder = F2(function(initialModel, update) {
          var addMessage = F2(function(rawMsg, _v0) {
            ...
            return _Utils_Tuple2(A2(update, msg, model), A3($elm$browser$Debugger$History$add, msg, model, history2));
          });
        ...
        var $elm$browser$Debugger$Main$loadNewHistory = F3(function(rawHistory, update, model) {
          ...
          if (_v0.$ === "Err") {
            return _Utils_Tuple2(_Utils_update(model, { overlay: $elm$browser$Debugger$Overlay$corruptImport }), $elm$core$Platform$Cmd$none);
          } else {
            var _v1 = _v0.a;
              ...
              switch (msg.$) {
                ...
                case "Up":
                  ...
                  if (_v4.$ === "Running") {
                    ...
                    var history2 = _v4.e;
                    var targetIndex = i + 1;
                    if (_Utils_cmp(targetIndex, $elm$browser$Debugger$History$size(history2)) < 0) {
                ...
                case "Upload":
                  ...
                  return A2($elm$browser$Debugger$Main$withGoodMetadata, model, function(metadata) {
                    ...
                    if (_v7.$ === "Err") {
                      ...
                      return _Utils_Tuple2(_Utils_update(model, { overlay: newOverlay }), $elm$core$Platform$Cmd$none);
                    } else {
                ...
                case "OverlayMsg":
                  ...
                  if (_v8.$ === "Nothing") {
                    return _Utils_Tuple2(_Utils_update(model, { overlay: $elm$browser$Debugger$Overlay$none }), $elm$core$Platform$Cmd$none);
                  } else {
        ...
        _Platform_export({ "Main": { "init": $author$project$Main$main($elm$json$Json$Decode$succeed(_Utils_Tuple0))({ "versions": { "elm": "0.19.1" }, "types": { "message": "Main.Msg", "aliases": {}, "unions": { "Main.Msg": { "args": [], "tags": { "Increment": [], "Decrement": [] } } } } }) } });
      })(exports);
    }
  });
